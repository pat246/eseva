...
public class BasicInfoPanel extends JPanel {
	...
	public BasicInfoPanel() {
		...
		JButton shortcut = new JButton("IE");
		JButton fxshortcut = new JButton("Firefox");
		JButton chromeS = new JButton("Chrome");
		addComponent(editCompany, 370, 5, 100, 18);
		addComponent(shortcut, 500, 5, 100, 18);
		addComponent(fxshortcut, 625, 5, 100, 18);
		addComponent(chromeS, 750, 5, 100, 18);
		...
		this.astericPass = new JLabel("");
		this.passText.setFont(f);
		this.astericPass.setFont(f);
		...
		addComponent(this.astericPass, 235, 225, 400, 30);
		...
		chromeS.addActionListener(comboHandler);
